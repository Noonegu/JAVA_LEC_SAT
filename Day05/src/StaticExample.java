/**
 * Staic 정적 메소드/클래스 전역 변수에만 사용이 됩니다.
 * @author TJ
 * 
...
public class StaticExample {
	...
	static void callStiaticAddCount() {
	...
	//non-static method
	void printNanme() {
		System.out.println("난 동적메서드에서 printName이야");
	}
	public static void main(String[] args) {
		...
		StaticCounterObject.addCount();
		StaticCounterObject.addCount();
		StaticCounterObject.addCount();// Static은 공용영역이라서 new 메소드 사용안함
		...
		//같은 클래스의 동적 메서드라 할지라도 new를 통해 자기자신을 heap 영역에 올리고 사용해야한다.
